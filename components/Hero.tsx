        ...
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-[1.08] tracking-tight text-forge-black mb-6 animate-fade-up">
            ...
            <span className="text-gradient-orange">
              site, the app and the backend.
            </span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-forge-black/60 leading-relaxed mb-8 max-w-xl animate-fade-up stagger-2">
            HiveForge does software, web development, design and AI.
            Websites in 48 hours. Custom systems when a brochure site is not enough.
            You only pay if you are happy with the work.
          </p>
          ...
          <div className="flex flex-wrap gap-4 animate-fade-up stagger-4">
            {[
              { icon: Smartphone, text: "Websites and apps" },
              { icon: TrendingUp, text: "Custom software" },
              { icon: Clock, text: "Sites live in 48 hours" },
            ].map(({ icon: Icon, text }) => (
              <div
                key={text}
